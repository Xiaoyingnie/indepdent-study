...
data <-  read_excel("/Users/cmh/ms/Sp2024/nimisha/Capstone-Project/data/data.xlsx", sheet = "data_merged") 
#data <- na.omit(data)  

data$country <- as.factor(data$country)
data$suicide_lifetime <- ifelse(data$suicide_lifetime == 1, 0, 1)

formula1 <- suicide_lifetime ~ country * (burden_sum + belong_sum) + burden_sum + belong_sum + country
